...
def rerank_top_k(blip_results: List[Dict], query: str) -> List[Dict]:
...
if __name__ == "__main__":
    ...
    try:
        # Step 1: System B (Top 20 Semantic)
        top_20 = retriever.search_blip(query, k=20)
        
        # Step 2: System C (Reranked)
